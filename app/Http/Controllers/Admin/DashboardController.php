...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        $bcgMatrix = [
            [
                'name' => 'Balinesa con Burbujas', 'type' => 'Balinesa',
                'growth' => 18, 'share' => 28, 'revenue' => 52100, 'quadrant' => 'star',
                'color' => '#C5A059',
            ],
            [
                'name' => 'Cena Romántica Grotto', 'type' => 'Cena',
                'growth' => 22, 'share' => 26, 'revenue' => 48500, 'quadrant' => 'star',
                'color' => '#C5A059',
            ],
            [
                'name' => 'Spa con Burbujas', 'type' => 'Experiencia',
                'growth' => 3, 'share' => 19, 'revenue' => 36200, 'quadrant' => 'cow',
                'color' => '#10B981',
            ],
            [
                'name' => 'Cena Terraza Mar', 'type' => 'Cena',
                'growth' => 5, 'share' => 12, 'revenue' => 22400, 'quadrant' => 'cow',
                'color' => '#10B981',
            ],
            [
                'name' => 'Balinesa Sunset', 'type' => 'Balinesa',
                'growth' => 15, 'share' => 8, 'revenue' => 15800, 'quadrant' => 'question',
                'color' => '#3B82F6',
            ],
            [
                'name' => 'Chef\'s Table Experience', 'type' => 'Experiencia',
                'growth' => 20, 'share' => 5, 'revenue' => 9200, 'quadrant' => 'question',
                'color' => '#3B82F6',
            ],
            [
                'name' => 'Cena Básica Interior', 'type' => 'Cena',
                'growth' => -2, 'share' => 3, 'revenue' => 6500, 'quadrant' => 'dog',
                'color' => '#EF4444',
            ],
            [
                'name' => 'Masaje Express', 'type' => 'Experiencia',
                'growth' => -5, 'share' => 2, 'revenue' => 4100, 'quadrant' => 'dog',
                'color' => '#EF4444',
            ],
        ];
        ...
        // ── 00b. Previsiones de Inventario ──
        $inventory = [
            [
                'item' => 'Moët & Chandon Brut 750ml', 'stock' => 24, 'reserved' => 18,
                'minStock' => 10, 'unit' => 'botellas', 'status' => 'ok',
            ],
            [
                'item' => 'Tequila Don Julio 70', 'stock' => 12, 'reserved' => 8,
                'minStock' => 5, 'unit' => 'botellas', 'status' => 'ok',
            ],
            [
                'item' => 'Decoración rosas premium', 'stock' => 30, 'reserved' => 22,
                'minStock' => 15, 'unit' => 'ramos', 'status' => 'ok',
            ],
            [
                'item' => 'Champagne Veuve Clicquot', 'stock' => 6, 'reserved' => 8,
                'minStock' => 5, 'unit' => 'botellas', 'status' => 'warning',
            ],
            [
                'item' => 'Langosta (kg)', 'stock' => 8, 'reserved' => 10,
                'minStock' => 5, 'unit' => 'kg', 'status' => 'danger',
            ],
        ];
        ...
        $alerts = [
            [
                'severity' => 'warning', 'zone' => 'Balinesas',
                'message'  => 'Balinesas Beach Club: 2 de 8 disponibles',
                'detail'   => 'Límite operativo de 3 disponibles antes de restricción',
                'indicator' => '🟡',
            ],
            [
                'severity' => 'danger', 'zone' => 'The Grotto',
                'message'  => 'Mesas The Grotto: 0 de 12 disponibles',
                'detail'   => 'Overbooking alcanzado — considerar cierre de ventas',
                'indicator' => '🔴',
            ],
            [
                'severity' => 'info', 'zone' => 'SPA',
                'message'  => 'Experiencias SPA: 5 de 6 slots ocupados',
                'detail'   => 'Próximo turno completo en 2 horas',
                'indicator' => '🟢',
            ],
        ];
