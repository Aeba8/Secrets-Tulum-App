                    ...
                    <table class="w-full text-sm whitespace-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-sand-200 dark:border-charcoal-500 last:border-0 hover:bg-sand-50 dark:hover:bg-charcoal-500 transition-colors">
                                    ...
                                    @if(!empty($ba['imagenes']))
                                        <div class="flex items-center justify-center gap-1">
                                            ...
                                            @if(count($ba['imagenes']) > 3)
                                                <span class="text-xs text-gray-400 ml-1">+{{ count($ba['imagenes']) - 3 }}</span>
                                            @endif
                                        </div>
                                    @else
                                ...
                                <td class="px-5 py-3.5 text-center">
                                    <span class="text-xs px-2 py-0.5 rounded-md border {{ $ba['status'] === 'Activo' ? 'bg-sapphire-50 dark:bg-sapphire-900/20 text-sapphire-600 dark:text-sapphire-400 border-sapphire-200 dark:border-sapphire-800' : 'bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400 border-gray-200 dark:border-gray-700' }}">{{ $ba['status'] }}</span>
                                </td>
                                <td class="px-5 py-3.5 text-center">
