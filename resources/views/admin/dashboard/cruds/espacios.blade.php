                            ...
                            <tr data-id="{{ $e->Id }}" data-estado="{{ $e->Estado }}" data-activo="{{ $e->Is_Active }}"
                                ...
                                <td class="px-5 py-3.5 text-center">
                                    <div
                                        ...
                                        <button onclick="reordenar('espacios', {{ $e->Id }}, 'up', this)" class="hover:text-gold-500 transition-colors" title="Subir"><i class="fa-solid fa-chevron-up text-xs"></i></button>
                                        <button onclick="reordenar('espacios', {{ $e->Id }}, 'down', this)" class="hover:text-gold-500 transition-colors" title="Bajar"><i class="fa-solid fa-chevron-down text-xs"></i></button>
                                        <button
