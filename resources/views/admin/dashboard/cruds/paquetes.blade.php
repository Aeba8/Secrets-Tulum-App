                    ...
                    <table class="w-full text-sm whitespace-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-sand-200 dark:border-charcoal-500 last:border-0 hover:bg-sand-50 dark:hover:bg-charcoal-500 transition-colors">
                                ...
                                <td class="px-5 py-3.5 text-gray-900 dark:text-gray-100 text-right font-mono">${{ number_format($pe->Precio, 2) }}</td>
                                <td class="px-5 py-3.5 text-gray-500 dark:text-gray-400 text-right font-mono text-sm">{{ $pe->Costo_Operativo ? '$' . number_format($pe->Costo_Operativo, 2) : '—' }}</td>
                                <td class="px-5 py-3.5 text-gray-900 dark:text-gray-100 text-center font-mono">{{ $pe->numero_personas ?? '—' }}</td>
                                ...
                                <td class="px-5 py-3.5 text-center">
                                    <span class="text-xs px-2 py-0.5 rounded-md border {{ ($pe->Estado ?? 'Inactivo') === 'Activo' ? 'bg-sapphire-50 dark:bg-sapphire-900/20 text-sapphire-600 dark:text-sapphire-400 border-sapphire-200 dark:border-sapphire-800' : 'bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400 border-gray-200 dark:border-gray-700' }}">
                                        {{ $pe->Estado ?? 'Inactivo' }}
                                    </span>
                                </td>
                                <td class="px-5 py-3.5 text-center">
                                    <div class="flex items-center justify-center gap-2 text-gray-400 dark:text-gray-500">
                                        ...
                                        <form method="POST" action="{{ route('admin.experiencias.destroy', $pe->Id) }}" class="inline form-confirm" data-message="¿Desactivar esta experiencia?">
                                            @csrf @method('DELETE')
                                        ...
                                        @else
                                        <form method="POST" action="{{ route('admin.experiencias.activate', $pe->Id) }}" class="inline form-confirm" data-message="¿Activar esta experiencia?">
                                            @csrf @method('PATCH')
                            ...
                            @empty
                            <tr>
                                <td colspan="8" class="px-5 py-8 text-center text-gray-400 dark:text-gray-500 text-sm">No hay experiencias registradas. ¡Crea la primera!</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="experiencia_tipo" name="tipo" maxlength="100" placeholder="Ej: Spa, Gastronomía"
                                    class="w-full px-3 py-2.5 rounded-xl border border-sand-200 dark:border-charcoal-500 bg-white dark:bg-charcoal-700 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500/40 focus:border-gold-500 transition">
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="experiencia_duracion" name="duracion" maxlength="100" placeholder="Ej: 2 horas"
                                    class="w-full px-3 py-2.5 rounded-xl border border-sand-200 dark:border-charcoal-500 bg-white dark:bg-charcoal-700 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500/40 focus:border-gold-500 transition">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Horario</label>
                                <input type="text" id="experiencia_horario" name="horario" maxlength="100" placeholder="Ej: 18:00"
                                    class="w-full px-3 py-2.5 rounded-xl border border-sand-200 dark:border-charcoal-500 bg-white dark:bg-charcoal-700 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500/40 focus:border-gold-500 transition">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" id="experiencia_precio" name="precio" step="0.01" min="0" max="999999.99" required
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm">$</span>
                                    <input type="number" id="experiencia_costo_operativo" name="costo_operativo" step="0.01" min="0" max="999999.99"
                                        class="w-full pl-7 pr-3 py-2.5 rounded-xl border border-sand-200 dark:border-charcoal-500 bg-white dark:bg-charcoal-700 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500/40 focus:border-gold-500 transition">
                                </div>
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Personas</label>
                                <input type="number" id="experiencia_numero_personas" name="numero_personas" min="1" max="500"
                                    class="w-full px-3 py-2.5 rounded-xl border border-sand-200 dark:border-charcoal-500 bg-white dark:bg-charcoal-700 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500/40 focus:border-gold-500 transition">
                            </div>
                        </div>

                        <div>
                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Productos / Alimentos o Bebidas</label>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Botella incluida</label>
                                <input type="text" id="experiencia_botella" name="botella" maxlength="255" placeholder="Ej: Casa Madero 2V"
                                    class="w-full px-3 py-2.5 rounded-xl border border-sand-200 dark:border-charcoal-500 bg-white dark:bg-charcoal-700 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500/40 focus:border-gold-500 transition">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Servicio extra</label>
                                <input type="text" id="experiencia_servicio_extra" name="servicio_extra" maxlength="255" placeholder="Ej: Spa 40 minutos"
                                    class="w-full px-3 py-2.5 rounded-xl border border-sand-200 dark:border-charcoal-500 bg-white dark:bg-charcoal-700 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500/40 focus:border-gold-500 transition">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="hidden" id="experiencia_imagenes_eliminar" name="imagenes_eliminar" value="">
        ...
        {{-- Confirmación --}}
        <div id="experienciaConfirmModal" class="fixed inset-0 bg-black/60 backdrop-blur-sm hidden items-center justify-center z-[60] p-4">
            <div class="bg-white dark:bg-charcoal-600 border border-sand-200 dark:border-charcoal-500 rounded-2xl w-full max-w-sm shadow-2xl p-6 text-center">
                ...
                <p id="experienciaConfirmMessage" class="text-gray-900 dark:text-gray-100 font-medium text-base mb-6"></p>
                    ...
                    if (data.imagenes && data.imagenes.length > 0) {
                        data.imagenes.forEach(function(url, index) {
                            ...
                            wrapper.innerHTML =
                                ...
                                '<button type="button" onclick="expConfirmEliminarImagen(' + index + ', \'' + url.replace(/'/g, "\\'") +
