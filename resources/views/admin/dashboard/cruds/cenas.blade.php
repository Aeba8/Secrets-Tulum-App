                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <textarea id="cena_entrada" name="entrada" rows="2" maxlength="1000" placeholder="Ej: Carpaccio de res, bruschetta..."
                            ...
                            <div>
                                ...
                                <textarea id="cena_crema" name="crema" rows="2" maxlength="1000" placeholder="Ej: Crema de elote trufada..."
                                    class="w-full px-3 py-2.5 rounded-xl border border-sand-200 dark:border-charcoal-500 bg-white dark:bg-charcoal-700 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500/40 focus:border-gold-500 transition resize-none"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <textarea id="cena_plato_fuerte" name="plato_fuerte" rows="2" maxlength="1000" placeholder="Ej: Filete en salsa de vino tinto..."
                                    class="w-full px-3 py-2.5 rounded-xl border border-sand-200 dark:border-charcoal-500 bg-white dark:bg-charcoal-700 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500/40 focus:border-gold-500 transition resize-none"></textarea>
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-1">Postre</label>
                                <textarea id="cena_postre" name="postre" rows="2" maxlength="1000" placeholder="Ej: Tiramisú de chocolate..."
                                    class="w-full px-3 py-2.5 rounded-xl border border-sand-200 dark:border-charcoal-500 bg-white dark:bg-charcoal-700 text-gray-900 dark:text-gray-100 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500/40 focus:border-gold-500 transition resize-none"></textarea>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="file" id="cena_imagenes" name="imagenes[]" multiple accept="image/jpeg,image/png,image/webp"
