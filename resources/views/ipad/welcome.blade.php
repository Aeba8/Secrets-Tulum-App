...
<body id="welcome-body"
    ...
    <div translate="no"
        class="relative z-10 w-full text-center pt-8 text-[12px] tracking-[0.6em] font-light uppercase text-[#D4AF37]/60">
    ...
    <div class="relative z-10 flex flex-col items-center justify-center text-center my-auto px-6 space-y-16">
        ...
        <div class="space-y-4">
            ...
            <h1
                class="font-serif-luxury text-5xl md:text-6xl lg:text-7xl font-extralight text-white tracking-[0.2em] leading-tight drop-shadow-2xl">
                SECRETS PAD
            </h1>
            <div class="w-16 h-[1px] bg-gradient-to-r from-transparent via-[#D4AF37]/50 to-transparent mx-auto mt-8">
            </div>
        </div>

        <!-- NUEVO DISEÑO DE BOTONES: Interfaz Lineal Minimalista de Ultra Lujo -->
        <div
            class="flex flex-row items-center justify-center h-20 relative px-8 bg-black/10 backdrop-blur-md border border-white/[0.03] rounded-full shadow-2xl">
            ...
            <button onclick="selectLanguage('es')"
                ...
                <span
                    class="text-white/80 font-light text-[13px] tracking-[0.3em] uppercase group-hover:text-[#D4AF37] group-hover:-translate-y-0.5 transition-all duration-500">
                    Español
                </span>
                <!-- Línea de acento inferior animada -->
                <div
                    class="absolute bottom-4 left-1/2 -translate-x-1/2 w-0 h-[1px] bg-[#D4AF37] group-hover:w-8 transition-all duration-500 opacity-0 group-hover:opacity-100">
                </div>
            </button>
